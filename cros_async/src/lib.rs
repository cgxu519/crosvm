...
///    };
///    ```
pub fn select2<F1: Future, F2: Future>(
    f1: F1,
    f2: F2,
) -> Result<(SelectResult<F1>, SelectResult<F2>)> {
    FdExecutor::new(select::Select2::new(f1, f2)).map(|mut f| f.run())
}
...
pub fn select3<F1: Future, F2: Future, F3: Future>(
    ...
    FdExecutor::new(select::Select3::new(f1, f2, f3)).map(|mut f| f.run())
}
...
pub fn select4<F1: Future, F2: Future, F3: Future, F4: Future>(
    ...
    FdExecutor::new(select::Select4::new(f1, f2, f3, f4)).map(|mut f| f.run())
}
...
pub fn select5<F1: Future, F2: Future, F3: Future, F4: Future, F5: Future>(
    ...
    FdExecutor::new(select::Select5::new(f1, f2, f3, f4, f5)).map(|mut f| f.run())
}
...
///    ```
pub fn complete2<F1: Future, F2: Future>(f1: F1, f2: F2) -> Result<(F1::Output, F2::Output)> {
    FdExecutor::new(complete::Complete2::new(f1, f2)).map(|mut f| f.run())
}
...
///    use cros_async::fd_executor::add_future;
///
///    assert_eq!(complete3(async{1}, async{2}, async{3}).unwrap_or((0,0,0)), (1,2,3));
///    ```
pub fn complete3<F1: Future, F2: Future, F3: Future>(
    ...
    FdExecutor::new(complete::Complete3::new(f1, f2, f3)).map(|mut f| f.run())
}
...
///    use cros_async::fd_executor::add_future;
///
///    assert_eq!(complete4(async{1}, async{2}, async{3}, async{4}).unwrap_or((0,0,0,0)),
///               (1,2,3,4));
///    ```
pub fn complete4<F1: Future, F2: Future, F3: Future, F4: Future>(
    ...
    FdExecutor::new(complete::Complete4::new(f1, f2, f3, f4)).map(|mut f| f.run())
}
...
///
///    assert_eq!(
///        complete5(async{1}, async{2}, async{3}, async{4}, async{5}).unwrap_or((0,0,0,0,0)),
///        (1,2,3,4,5));
///    ```
pub fn complete5<F1: Future, F2: Future, F3: Future, F4: Future, F5: Future>(
    ...
    FdExecutor::new(complete::Complete5::new(f1, f2, f3, f4, f5)).map(|mut f| f.run())
}
